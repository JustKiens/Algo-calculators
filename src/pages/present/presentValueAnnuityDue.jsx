...
const PresentValueAnnuityDue = () => {
  // Formula to calculate the present value of an annuity due
  const formula = (r, pmt, n) => (pmt * (1 - Math.pow(1 + r, -n)) / r) * (1 + r);
  ...
  return (
    <div className="text-center p-6 bg-green-50 min-h-screen">
      <h2 className="text-3xl font-bold mb-2 text-green-800">Present Value of Annuity Due</h2>
      <p className="text-green-600 mb-4">
        The present value of an annuity due is calculated using the formula:
      </p>
      <p className="text-green-600 mb-6">
        <strong>PV = PMT * (1 - (1 + r)<sup>-n</sup>) / r * (1 + r)</strong>
      </p>
...
export default PresentValueAnnuityDue;
